...
#### Keyboard presets
FM Rhodes (4): DX7-style tine piano — a 1:1 body operator pair whose index decays over 400ms and a 14:1 tine pair that rings for 90ms, five roots (C2–C6), soft/hard velocity layers, 6.5s envelope decay shortened for high keys, 4.3Hz tremolo. Tonewheel Organ (16): drawbars 16'/5⅓'/8'/4'/2⅔' at 8-8-8-3-2, decaying 2nd-harmonic percussion, key click, 6.2Hz chorale vibrato and a heavy chorus send. Vibraphone (11): fundamental + 4th partial + bar overtone, mallet thump, 4Hz motor tremolo. Clavinet (7): narrow pulse pluck with the SF2 filter envelope doing the pickup "wah" (1.3kHz + 3600 cents, 160ms). Every tone is generated at an exact integer period so the tail loops seamlessly; the envelope does the decay. Only the acoustic piano (jazz styles), horns and the electric basses still come from FluidR3.
