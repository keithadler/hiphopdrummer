 ...
 */
var BASS_STYLES = {
  // FIX #3: Reduced octave drops to 0.05-0.15 range for emphasis only (not every bar)
  // FIX #6: Capped hammer-on probability at 0.05-0.1 maximum
  // FIX #8: Adjusted slide probabilities per style
  normal:    { rhythm: 'kick', density: 0.9, velBase: 100, velRange: 12, noteDur: 0.5,
               useFifth: 0.2, useOctaveDrop: 0.10, walkUp: 0.15,
  ...
  hard:      { rhythm: 'kick', density: 1.0, velBase: 115, velRange: 6, noteDur: 0.4,
               useFifth: 0.1, useOctaveDrop: 0.15, walkUp: 0.0,
  ...
  jazzy:     { rhythm: 'eighth', density: 0.6, velBase: 85, velRange: 20, noteDur: 0.7,
               useFifth: 0.4, useOctaveDrop: 0.12, walkUp: 0.3,
               slideProb: 0.02, ghostNoteDensity: 0.2, timingOffset: -1,
  ...
  dark:      { rhythm: 'kick', density: 0.7, velBase: 110, velRange: 8, noteDur: 0.8,
               useFifth: 0.05, useOctaveDrop: 0.20, walkUp: 0.0,
  ...
  bounce:    { rhythm: 'kick', density: 0.95, velBase: 100, velRange: 10, noteDur: 0.5,
               useFifth: 0.25, useOctaveDrop: 0.10, walkUp: 0.2,
               ...
               subSwell: 0.0, restProb: 0.05, hammerOnProb: 0.08, timingJitter: 0, velCompression: 0.0, energyArc: true, instrument: 'bassguitar' },
  ...
  dilla:     { rhythm: 'kick', density: 0.85, velBase: 90, velRange: 18, noteDur: 0.6,
               useFifth: 0.35, useOctaveDrop: 0.15, walkUp: 0.2,
               ...
               subSwell: 0.0, restProb: 0.15, hammerOnProb: 0.05, timingJitter: 6, velCompression: 0.0, energyArc: false, instrument: 'bassguitar' },
  lofi:      { rhythm: 'kick', density: 0.8, velBase: 80, velRange: 8, noteDur: 0.4,
               useFifth: 0.15, useOctaveDrop: 0.20, walkUp: 0.1,
  ...
  gfunk:     { rhythm: 'kick', density: 0.9, velBase: 95, velRange: 12, noteDur: 0.85,
               useFifth: 0.35, useOctaveDrop: 0.20, walkUp: 0.25,
  ...
  griselda:  { rhythm: 'kick', density: 0.9, velBase: 108, velRange: 8, noteDur: 0.4,
               useFifth: 0.1, useOctaveDrop: 0.12, walkUp: 0.0,
  ...
  nujabes:   { rhythm: 'eighth', density: 0.5, velBase: 80, velRange: 18, noteDur: 0.7,
               useFifth: 0.4, useOctaveDrop: 0.12, walkUp: 0.3,
               slideProb: 0.02, ghostNoteDensity: 0.2, timingOffset: -2,
  ...
  sparse:    { rhythm: 'kick', density: 0.5, velBase: 95, velRange: 10, noteDur: 0.6,
               useFifth: 0.0, useOctaveDrop: 0.10, walkUp: 0.0,
               slideProb: 0.0, ghostNoteDensity: 0.0, timingOffset: 0,
               useMinor7th: 0.0, octaveUpProb: 0.0, deadNoteProb: 0.0,
               walkDirection: 'below', walkDiatonic: 0.0, backbeatAccent: 0, chordAnticipation: 0.0,
               subSwell: 0.0, restProb: 0.0, hammerOnProb: 0.0, timingJitter: 0, velCompression: 0.0, energyArc: false, instrument: 'bassguitar' },
  driving:   { rhythm: 'kick', density: 0.95, velBase: 105, velRange: 10, noteDur: 0.5,
               useFifth: 0.15, useOctaveDrop: 0.10, walkUp: 0.1,
               ...
               subSwell: 0.0, restProb: 0.03, hammerOnProb: 0.05, timingJitter: 0, velCompression: 0.0, energyArc: true, instrument: 'bassguitar' },
