...
var STYLE_DATA = {
  ...
  driving:   { label: 'Driving',           bpmRange: [92, 100], keys: ['Am','Dm','Em','Cm','Gm'],               artists: 'DJ Premier (Gangstarr), EPMD, Erick Sermon, Redman', drumKit: 0, bassSound: 34 },
  sparse:    { label: 'Sparse',            bpmRange: [72, 92],  keys: ['Am','Dm','Em','Cm','Fm'],               artists: 'RZA, Alchemist, early Wu-Tang, Roc Marciano', drumKit: 0, bassSound: 39 },
  dilla:     { label: 'Dilla / Neo-Soul',  bpmRange: [78, 95],  keys: ['Dm7','Am7','Gm7','Em7','Cm7','Fm7'],     artists: 'J Dilla, Madlib, Karriem Riggins, Slum Village, Kaytranada', drumKit: 8, bassSound: 35 },
  lofi:      { label: 'Lo-Fi / Dusty',     bpmRange: [75, 92],  keys: ['Cm7','Fm','Dm','Am7','Gm','Fm7'],        artists: 'Madlib, Knxwledge, MF DOOM, Roc Marciano, Dibia$e', drumKit: 8, bassSound: 35 },
  chopbreak: { label: 'Chopped Break',     bpmRange: [88, 98], keys: ['Am','Dm','Em','Gm','Cm','Fm'],          artists: 'DJ Premier, Havoc, Alchemist, Large Professor, Pete Rock', drumKit: 0, bassSound: 33 },
  gfunk:     { label: 'G-Funk',            bpmRange: [85, 100], keys: ['Gm7','Dm7','Cm7','Am7','Fm7','Em7'],     artists: 'Dr. Dre, DJ Quik, Warren G, Snoop Dogg, Too Short, Nate Dogg', drumKit: 25, bassSound: 38 },
  gfunk_dre: { label: 'G-Funk — Dre',     bpmRange: [88, 98], keys: ['Gm7','Dm7','Cm7','Am7'],           artists: 'Dr. Dre, Snoop Dogg, Warren G — polished, controlled, deep sub', drumKit: 25, bassSound: 38 },
  gfunk_quik: { label: 'G-Funk — DJ Quik', bpmRange: [90, 100], keys: ['Gm7','Dm7','Cm7','Fm7','Am7','Em7'],   artists: 'DJ Quik, 2nd II None, Hi-C, Too Short — raw funk, busier kick, more ghosts', drumKit: 25, bassSound: 36 },
  gfunk_battlecat: { label: 'G-Funk — Battlecat', bpmRange: [85, 95], keys: ['Gm7','Cm7','Fm7','Dm7'],          artists: 'Battlecat, Snoop Dogg, Tha Dogg Pound — heavy bounce, deep swing', drumKit: 25, bassSound: 38 },
  crunk:     { label: 'Crunk',             bpmRange: [135, 150],  keys: ['Am','Dm','Em','Cm','Gm','Fm','Bbm'],       artists: 'Lil Jon, Ying Yang Twins, Three 6 Mafia, Trillville', drumKit: 25, bassSound: 38 },
