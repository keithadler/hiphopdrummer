...
var STYLE_DATA = {
  ...
  crunk:     { label: 'Crunk',             bpmRange: [70, 78],  keys: ['Am','Dm','Em','Cm','Gm'],               artists: 'Lil Jon, Ying Yang Twins, Three 6 Mafia, Trillville' },
  ...
  phonk:     { label: 'Phonk / Cloud Rap', bpmRange: [68, 78],  keys: ['Cm','Fm','Bbm','Gm','Am','Ebm'],         artists: 'SpaceGhostPurrp, DJ Smokey, Soudiere, DJ Yung Vamp' },
