...
var STYLE_DATA = {
  ...
  dark:      { label: 'Dark Minimal',      bpmRange: [68, 88], bpms: [68,70,72,75,78,80,85,88], keys: ['Cm','Abm','Fm','Bbm','Gm','Ebm','Dbm'],        artists: 'RZA, Daringer, Havoc, Griselda, Westside Gunn', drumKit: 0, bassSound: 39 },
  ...
  dilla:     { label: 'Dilla / Neo-Soul',  bpmRange: [78, 95], bpms: [78,80,85,88,90,92,95], keys: ['Dm7','Am7','Gm7','Em7','Cm7','Fm7'],     artists: 'J Dilla, Madlib, Karriem Riggins, Slum Village, Kaytranada', drumKit: 8, bassSound: 35 },
  ...
  gfunk_dre: { label: 'G-Funk — Dre',     bpmRange: [88, 98], bpms: [88,90,92,95,98], keys: ['Gm7','Dm7','Cm7','Am7'],           artists: 'Dr. Dre, Snoop Dogg, Warren G — polished, controlled, deep sub', drumKit: 25, bassSound: 38 },
  gfunk_quik: { label: 'G-Funk — DJ Quik', bpmRange: [90, 100], bpms: [90,92,95,98,100], keys: ['Gm7','Dm7','Cm7','Fm7','Am7','Em7'],   artists: 'DJ Quik, 2nd II None, Hi-C, Too Short — raw funk, busier kick, more ghosts', drumKit: 25, bassSound: 36 },
  gfunk_battlecat: { label: 'G-Funk — Battlecat', bpmRange: [85, 95], bpms: [85,88,90,92,95], keys: ['Gm7','Cm7','Fm7','Dm7'],          artists: 'Battlecat, Snoop Dogg, Tha Dogg Pound — heavy bounce, deep swing', drumKit: 25, bassSound: 38 },
  ...
  memphis:   { label: 'Memphis',           bpmRange: [68, 85], bpms: [68,70,72,75,78,80,85], keys: ['Cm','Fm','Bbm','Gm','Am','Ebm','Abm'],         artists: 'Three 6 Mafia, DJ Paul, Juicy J, Gangsta Boo, Koopsta Knicca', drumKit: 25, bassSound: 38 },
  griselda:  { label: 'Griselda Revival',  bpmRange: [72, 92], bpms: [72,75,78,80,85,88,90,92], keys: ['Cm','Dm','Am','Fm','Gm','Bbm','Ebm'],          artists: 'Daringer, Beat Butcha, Conductor Williams, Westside Gunn, Conway', drumKit: 0, bassSound: 39 },
  phonk:     { label: 'Phonk / Cloud Rap', bpmRange: [120, 140], bpms: [120,125,130,135,140], keys: ['Cm','Fm','Bbm','Gm','Am','Ebm'],         artists: 'SpaceGhostPurrp, DJ Smokey, Soudiere, DJ Yung Vamp', drumKit: 24, bassSound: 38 },
