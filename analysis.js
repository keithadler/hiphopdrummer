...
function analyzeBeat() {
  ...
  lines.push('');
  lines.push('<span style="font-size:0.85em;color:#404058;font-style:italic;">Artist and track references are for educational purposes only. Hip Hop Drummer is not affiliated with or endorsed by any artist, producer, or label mentioned. All product names, logos, and brands (including Roland, TR-808, Akai, MPC, E-mu, SP-1200, Moog, Minimoog, Korg, Juno, Prophet, Oberheim, Fender Rhodes, Wurlitzer, Teenage Engineering, Ensoniq, Boss, Casio, and others) are trademarks of their respective owners. Use of these names is for descriptive and educational purposes only and does not imply endorsement.</span>');
