...
function analyzeBeat() {
  ...
  var spotlights = [
    ...
    '<b>G-Funk\'s 16th Note Hats</b> — The defining sound of West Coast G-Funk isn\'t the synth bass or the P-Funk samples — it\'s the hi-hat. Dr. Dre and DJ Quik used 16th note hats with a specific 3-level dynamic: quarter notes loud, 8th note upbeats medium, and the "e" and "ah" positions very soft. This creates a rolling, hypnotic feel that 8th note hats can\'t replicate. The wide dynamic range makes the hat feel alive — it\'s not a metronome, it\'s a conversation. In this generator, the G-Funk feel forces 16th note hats and preserves that 3-level dynamic without the generic accent curve overriding it.',
    '<b>Crunk\'s Flat Dynamics</b> — Crunk is the only hip hop style where dynamic variation is the enemy. Lil Jon\'s beats hit at maximum velocity on every single element — kick, snare, clap, hats all at 100%. There are no ghost notes, no accent curves, no velocity arc. The energy comes from density and volume, not from dynamics. This is the opposite of every other hip hop style. In this generator, the crunk feel skips the velocity arc, skips the hat accent curve, skips ghost clustering, and locks the kick accent flat. The result is a beat that sounds like a machine — which is exactly what crunk is supposed to sound like.',
    '<b>Memphis Rap\'s Sinister Space</b> — Three 6 Mafia and DJ Paul built one of the most distinctive drum aesthetics in hip hop by doing almost nothing. Sparse kick, barely-there hats, minimal ghost notes, and a snare that snaps rather than cracks. The space between hits is where the menace lives. Memphis beats are defined by what\'s absent — your brain fills in the missing elements with dread. In this generator, the Memphis feel uses a dedicated sparse kick library, caps ghost density at 0.6, makes ghost snares barely audible (35-45% velocity), and gives the open hat a 50/50 chance of being on &2 instead of the standard &4.'
  ];
  ...
  var didYouKnow = [
    ...
    'Dr. Dre\'s G-Funk sound was built on P-Funk samples from Parliament and Funkadelic. The slow tempos (80-95 BPM), heavy swing, and 16th note hats were designed to complement the long, sustained synth bass lines that defined the West Coast sound.',
    'Lil Jon\'s crunk beats were deliberately mechanical — he wanted the drums to sound like a machine, not a human. The flat dynamics and 4-on-the-floor kick were a reaction against the nuanced, ghost-note-heavy boom bap of the East Coast.',
    'Three 6 Mafia\'s DJ Paul and Juicy J were making beats in Memphis in the early 1990s before they had proper studio equipment. Their early cassette tapes circulated through the city\'s underground scene and created the Memphis rap aesthetic — dark, sparse, and sinister — that influenced trap music decades later.',
    'The halftime feel (snare on beat 3 instead of 2 and 4) creates the illusion that the tempo is half as fast. Havoc of Mobb Deep used this technique extensively — "Shook Ones Pt. II" feels slow and heavy even though it\'s at 81 BPM because the snare only hits once every two beats.'
  ];
  ...
  var history = [
    ...
    '<b>G-Funk\'s West Coast Takeover (1992-1996)</b> — When Dr. Dre left N.W.A and founded Death Row Records, he developed a new sound that would dominate hip hop for half a decade. G-Funk borrowed the slow tempos and P-Funk samples of George Clinton\'s catalog, added 16th note hats with wide dynamics, and built everything around a deep, sustained synth bass. "The Chronic" (1992) and "Doggystyle" (1993) defined the West Coast sound. DJ Quik and Warren G refined it further — the 1-and-3 kick pattern, the laid-back snare, and the rolling hat became the signature of an entire region.',
    '<b>Crunk\'s Atlanta Explosion (2003-2007)</b> — Lil Jon and the East Side Boyz created crunk by stripping hip hop drums to their most aggressive elements. 4-on-the-floor kicks, maximum-velocity snares and claps, driving 8th note hats, and almost no ghost notes. The result was a style designed for clubs — loud, relentless, and impossible to ignore. "Get Low" (2003) became the template. Ying Yang Twins, Three 6 Mafia, and Trillville all contributed to the sound. Crunk was the bridge between Southern hip hop and the electronic dance music that would follow.',
    '<b>Memphis Rap\'s Underground Legacy (1991-present)</b> — Before Three 6 Mafia became famous, DJ Paul and Juicy J were distributing cassette tapes through Memphis\'s underground network. The sound they developed — slow tempos, sparse drums, eerie samples, and menacing lyrics — was unlike anything else in hip hop. Memphis rap stayed underground for years, but its influence spread quietly. When trap music emerged from Atlanta in the 2000s, producers like Lex Luger and Zaytoven cited Memphis rap as a primary influence. The sinister, minimal drum aesthetic that Three 6 Mafia pioneered in the early 1990s is now one of the most influential sounds in modern music.'
  ];
  ...
  var mistakes = [
    ...
    '<b>Making G-Funk hats too uniform.</b> G-Funk\'s 16th note hats have a specific 3-level dynamic — quarter notes loud, 8th note upbeats medium, "e" and "ah" positions very soft. If you program all 16th notes at the same velocity, it sounds mechanical instead of smooth. The wide dynamic range is what creates the rolling, hypnotic West Coast feel. Program your quarter notes at 90%, 8th upbeats at 70%, and 16th "e/ah" positions at 45%.',
    '<b>Adding dynamics to crunk.</b> Crunk is supposed to sound like a machine. If you add ghost notes, velocity variation, or a dynamic arc to a crunk beat, it loses its identity. The flat, maximum-velocity approach IS the style. Resist the urge to make it more "musical" — the aggression comes from the uniformity.',
    '<b>Making Memphis beats too busy.</b> Memphis rap is defined by restraint. If you add ghost notes, busy kick patterns, or frequent open hats to a Memphis beat, it stops sounding sinister and starts sounding like boom bap. The space between hits is where the menace lives. Keep the kick sparse, the hats quiet, and the ghost notes barely audible. Less is more — much more.'
  ];
