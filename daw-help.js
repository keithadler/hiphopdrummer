...
function buildHelpGeneral(bpm, swing, noSwing) {
  ...
  return [
    ...
    '',
    'YOUR BEATS ARE YOURS',
    '--------------------',
    'Beats generated by Hip Hop Drummer are yours to use however you want —',
    'commercial releases, demos, freestyles, DJ sets, samples, anything.',
    'No attribution required, no royalties, no restrictions.',
    '',
    'All product names are trademarks of their respective owners. Not affiliated with or endorsed by any manufacturer mentioned.',
    '',
